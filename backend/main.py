...
evo2_image = (
    ...
    .run_commands("pip install 'transformer_engine[pytorch]==1.13'")
...
# Helper functions
# ------------------------------
def get_genome_sequence(position, genome, chromosome, window_size=8192):
    import requests
...
def print_endpoint_url():
    model = Evo2Model()
    print("\n✅ Your deployed FastAPI endpoint URL:")
    print(model.analyze_single_variant.web_url)
